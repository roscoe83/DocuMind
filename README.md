...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/your-username/DocuThinker-AI-App.git
...
You can also view the image in the **Docker Hub** repository **[here](https://hub.docker.com/repository/docker/your-username/docuthinker-ai-app/)**.
